...
" other functions and remaped the kays. Thanks to Aleksandar Jelenak a lot.
...
"     Move to a string (transl. or untransl) backward     \N
"     Begain to comment this entry                        \C
"     Move to an untransl. string forward                 \m
"     Move to an untransl. string backward                \M
...
if !hasmapto('<Plug>NextStringFWD')
	imap <buffer> <unique> <LocalLeader>n <Plug>NextStringFWD
	nmap <buffer> <unique> <LocalLeader>n <Plug>NextStringFWD
endif
...
if !hasmapto('<Plug>NextStringBWD')
	imap <buffer> <unique> <LocalLeader>N <Plug>NextStringBWD
	nmap <buffer> <unique> <LocalLeader>N <Plug>NextStringBWD
endif
...
if !hasmapto('<Plug>NextTransBwd')
	imap <buffer> <unique> <LocalLeader>M <Plug>NextTransBwd
	nmap <buffer> <unique> <LocalLeader>M <Plug>NextTransBwd
endif
